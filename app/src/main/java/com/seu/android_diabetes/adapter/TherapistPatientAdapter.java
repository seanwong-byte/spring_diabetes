...
public class TherapistPatientAdapter extends ArrayAdapter<DiabetesUser> {
    private Context mcontext;
    private int mresource;

    public TherapistPatientAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DiabetesUser> objects) {

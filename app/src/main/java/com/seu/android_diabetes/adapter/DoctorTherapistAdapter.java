...
public class DoctorTherapistAdapter extends ArrayAdapter<DiabetesUser> {
    private Context mcontext;
    private int mresource;

    public DoctorTherapistAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DiabetesUser> objects) {

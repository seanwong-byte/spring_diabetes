...
public class DoctorPatientAdapter extends ArrayAdapter<DiabetesUser> {
    private Context mcontext;
    private int mresource;

    public DoctorPatientAdapter(@NonNull Context context, int resource, @NonNull ArrayList<DiabetesUser> objects) {

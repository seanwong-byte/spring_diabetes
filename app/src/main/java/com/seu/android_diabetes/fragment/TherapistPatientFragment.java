...
import com.seu.android_diabetes.adapter.TherapistPatientAdapter;
...
public class TherapistPatientFragment extends Fragment {

    private ListView listView;
    private TherapistPatientAdapter doctorPatientAdapter;
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what){
                case Doctor_Patient:
                    ...
                    doctorPatientAdapter = new TherapistPatientAdapter(getActivity(),R.layout.doctor_listview_item,diabetePatientList);
